...
const alphabetizeBetter = (arr) => {
  // Solution code here...
  //Learned about localCompare: https://stackoverflow.com/questions/8996963/how-to-perform-case-insensitive-sorting-in-javascript
...
const sortPeopleBetter = (arr) => {
  // Solution code here...
  //Learned about return with an or operator here: https://stackoverflow.com/questions/6913512/how-to-sort-an-array-of-objects-by-multiple-fields/38037580
  return arr.sort((a, b) => {
    const compareLastName = a.lastName.localeCompare(b.lastName);
    const compareFirstName = a.firstName.localeCompare(b.firstName);
    const compareAge = a.age - b.age;

    return compareLastName || compareFirstName || compareAge;
  });
};
...
const sortMeetingsByDay = (arr) => {
  ...
  return arr.sort((a, b) => daysOfTheWeek.indexOf(a.dayOfWeek) - daysOfTheWeek.indexOf(b.dayOfWeek));
};
...
const sortSchedule = (arr) => {
  ...
  return arr.sort((a, b) => {
    const compareDayOfWeek = daysOfTheWeek.indexOf(a.dayOfWeek) - daysOfTheWeek.indexOf(b.dayOfWeek);
    const compareStartTime = a.start.localeCompare(b.start);
    const compareMeetingLength = (a.end - a.start) - (b.end - b.start);

    return compareDayOfWeek || compareStartTime || compareMeetingLength;
  });
};
