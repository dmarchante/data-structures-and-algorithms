...
//     let ingredientParsed = ingredient.split(' ').slice(2).join(' ');
//     result.push(ingredientParsed);
//   });
...
//     let stepParsed = step.substr(0, step.indexOf(' '));
//     result.push(stepParsed);
//   });
...
//   // Solution code here...
//   // (numberOfCharacters > str) : return '' ? 
//   let stringLength = str.length;

//   if (stringLength < numberOfCharacters) {
//     return '';
//   } else if (numberOfCharacters < 0) {
//     return str;
//   } else {
//     let stringArray = str.split('');
//     stringArray.splice(stringLength - numberOfCharacters, stringLength);
...
//   stringArray.forEach(s => numberArray.push(parseInt(s)));
...
//   // Solution code here...
//   return str.replace(/[AaEeIiOoUu]/g,'').split('').join('');
// };
