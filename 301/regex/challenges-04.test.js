...
//   // Solution code here...
//   const octRegEX = /^[Oo]ct$/;
//   const octoberRegEX = /^[Oo]ctober$/;

//   return (octRegEX.test(input) || octoberRegEX.test(input)) ? true : false;
// };
...
// let hangman = (str) => {
//   // Solution code here...
//   let string = str.replace(/[aeiou]/ig, '_');
//   return string;
// };
