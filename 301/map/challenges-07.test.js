...
//   arr.forEach(a => arrayMap.push(2 ** a));
...
// const charCode = (arr) => {
//   // Solution code here...
//   let arrayMap = arr.map(a => a.charCodeAt())
...
//   // Solution code here...
//   let arrayMap = arr.map(a => a.ability.name);
...
//     statsObject.name = a.stat.name;
//     statsObject.total = a.effort + a.baseStat;

//     arrayMap.push(statsObject);
//   });
